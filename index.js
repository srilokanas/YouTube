...
async function display(){
    ...
    let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=popular%20videos&key=AIzaSyC1xlvVqSJK_c7fF1fHNFIBIJIhlPfpCZA&maxResults=25`);
...
//search for videos
let res = await fetch(`https://youtube.googleapis.com/youtube/v3/search?q=${query}&type=video&key=AIzaSyC1xlvVqSJK_c7fF1fHNFIBIJIhlPfpCZA&maxResults=25`);
let data = await res.json();
